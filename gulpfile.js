...
var glob = {
    ...
    "html":     [build+'/_site/20*/**/*.html',build+'/_site/index.html',build+'/_site/archive/index.html'],
    "css":      '.tmp/*.css',
};
...
*/
gulp.task('jekyll', $.shell.task(['jekyll build --source build --destination build/_site/ --watch --drafts']) );
